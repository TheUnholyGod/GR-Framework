...
void UIManager::Init()
{
	...
	MeshList::GetInstance()->AddMesh("top", MeshBuilder::GetInstance()->GenerateQuad("top", Color(1, 1, 1), 1.f));
...
void UIManager::UpdateUI(double _dt)
{
	deltaTime = "FPS:" + std::to_string(1 / _dt);
	...
	//	light[0].position.z -= (float)(LSPEED * _dt);
	//if (Application::IsKeyPressed('K'))
	//	light[0].position.z += (float)(LSPEED * _dt);
	//if (Application::IsKeyPressed('J'))
	//	light[0].position.x -= (float)(LSPEED * _dt);
	//if (Application::IsKeyPressed('L'))
	//	light[0].position.x += (float)(LSPEED * _dt);
	//if (Application::IsKeyPressed('O'))
	//	light[0].position.y -= (float)(LSPEED * _dt);
